        ...
        $('#search_btn1').on('click',function() {
            ...
            $.ajax({
                ...
                success : function(result) {
                	$("#tbl").empty();
                	$("#tbl").append('<thead><tr><th>FIRST NAME</th><th>LAST NAME</th><th>USERID</th><th>DOB</th><th>EMAIL</th><th>MOBILE NO</th><th>COMPANY</th><th>DESIGNATION</th><th>ADDRESS</th><th></th></tr></thead>');
                	$("#tbl").append('<tfoot><tr><th>FIRST NAME</th><th>LAST NAME</th><th>USERID</th><th>DOB</th><th>EMAIL</th><th>MOBILE NO</th><th>COMPANY</th><th>DESIGNATION</th><th>ADDRESS</th><th></th></tr></tfoot>');
                	$("#tbl").append('<tbody>');
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                      ...
                      <li>
                        <a href="https://www.agilecrm.com/sales">Sales</a>
                    </li>
                    <li>
                        <a href="https://www.agilecrm.com/marketing">Marketing</a>
                    </li>
                    <li>
                        <a href="https://www.agilecrm.com/helpdesk">Services</a>
                    </li>
                    <li>
                        <a href="#">Services</a>
                    </li>
