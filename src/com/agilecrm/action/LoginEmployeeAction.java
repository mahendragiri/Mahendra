...
//        System.out.println("os "+agent.getOperatingSystem().getName());
//        System.out.println("os version"+agent.getOperatingSystem().getVersionNumber());
//        System.out.println("browser  "+UserAgentType.BROWSER);
//        System.out.println("mobile browser  "+UserAgentType.MOBILE_BROWSER);
//        System.out.println("email client  "+UserAgentType.EMAIL_CLIENT);
//        
//        
//        
//        
